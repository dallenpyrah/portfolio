...
.techstack:hover .tech-stack-line{
  opacity: 1;
}
.tech-stack-line{
  border-radius: 3rem;
...
.hover-background-left:hover .line-left{
  opacity: 1;
}
...
.hover-background-right:hover .line-right{
  opacity: 1;
}
.hover-background-right:hover .text-success{
  color:#000000!important;
}
.hover-background-right:hover .text-success .text-dark{
